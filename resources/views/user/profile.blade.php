...
@section('title', 'User Profile | Ecommerce Project')
            ...
            <div class="row justify-content-center">
                <div class="col-md-7">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('user.profile.submit') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" name="fullname" id="fullname" class="form-control"
                                                placeholder="Enter Full Name" required="" value="{{ $data->fullname }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-5">
                                            <img src="{{ isset($data) ? asset('backend_images/' . $data->profile) : '' }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a href="javascript:void(0)" data-id="{{ $data->id }}" type="button"
                                                class="btn btn-sm btn-dark mt-4" data-bs-toggle="modal" data-bs-target="#changePassword">
