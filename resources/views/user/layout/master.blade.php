            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('user.dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">TIDC User Panel</span>
                    </a>
                                ...
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        ...
                                        @if (Auth::guard('web')->user()->profile)
                                            <img src="{{ asset('backend_images/' . Auth::guard('web')->user()->profile) }}"
                                                alt class="w-px-40 h-auto rounded-circle" />
                                        @else
                                            <img src="{{ asset('backend_assets/img/avatars/admin-man.png') }}" alt
                                                    ...
                                                    <div class="avatar avatar-online">
                                                        @if (Auth::guard('web')->user()->profile)
                                                            <img src="{{ asset('backend_images/' . Auth::guard('web')->user()->profile) }}"
                                                                alt class="w-px-40 h-auto rounded-circle" />
                                                        @else
                                                            <img src="{{ asset('backend_assets/img/avatars/admin-man.png') }}"
                                                                alt class="w-px-40 h-auto rounded-circle" />
                                                        @endif
                                                    </div>
                                                </div>
