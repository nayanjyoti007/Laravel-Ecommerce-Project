        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-primary mb-3">Total Student Register</h4>
                            <div class="card-title mb-0 d-flex align-items-start justify-content-between">
                                <h3 class="new-bage">{{$usersToday}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-primary mb-3">Today Student Register</h4>
                            <div class="card-title mb-0 d-flex align-items-start justify-content-between">
                                <h3 class="new-bage text-danger">{{$usersTotal}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
