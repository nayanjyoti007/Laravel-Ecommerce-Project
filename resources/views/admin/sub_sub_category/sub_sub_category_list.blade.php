    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row justify-content-center">
                            ...
                            <table class="table table-bordered pt-3" id="myTable">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th>Sub Sub Catrgory Name (Eng) </th>
                                        <th>Sub Sub Catrgory Name (Hin) </th>
                                        <th>Category </th>
                                        <th>Sub Category </th>
                                        <th>Status </th>
                                        <th>Action</th>
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    @forelse ($sub_subcategory as $item)
                                        <tr id="trRow{{ $item->id }}">
                                            ...
                                            <td>
                                                {{ $item->sub_sub_category_name_hin }}
                                            </td>
                                            <td>
                                               {{ $item->category->category_name_en}}
                                            </td>
                                            <td>
                                                {{ $item->sub_category->sub_category_name_en}}
                                             </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('admin.sub.sub.category.form', ['id' => $item->id])}}"
                ...
                <div class="col-md-2">
                    <a href="{{route('admin.sub.sub.category.form')}}" class="btn btn-primary">Add Sub Sub Category</a>
                </div>
            </div>
