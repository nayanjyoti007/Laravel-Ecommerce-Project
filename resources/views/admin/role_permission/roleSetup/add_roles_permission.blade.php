...
@section('title', 'Admin | Ecommerce Project | Add Role in Permission')
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.storeRolePermission') }}" method="post"
                                                    ...
                                                    <div class="mb-3 col-md-12">
                                                        <div class="form-check mt-1">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="{{ $permission->id }}"
                                                                name="permission_id[]" id="{{ $permission->id }}">
