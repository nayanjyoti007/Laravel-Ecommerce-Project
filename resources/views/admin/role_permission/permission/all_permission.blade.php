...
@section('title', 'Admin | Ecommerce Project | Permission')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row justify-content-center">
                                    ...
                                    @forelse ($permissions as $item)
                                        <tr id="trRow{{ $item->id }}">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.permission.editPermission', ['id' => $item->id]) }}"
                ...
                <div class="col-md-2">
                    <a href="{{ route('admin.permission.addPermission') }}" class="btn btn-primary">Add Permission</a>
                </div>
            </div>
                    ...
                    swal({
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                ...
                                $.ajax({
                                    type: "GET",
                                    url: "{{ route('admin.permission.deletePermission') }}",
                                    data: {
                                        id: id
                                    },
